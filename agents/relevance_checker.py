...
class RelevanceChecker:
    def __init__(self):
        self.model = get_model(max_completion_tokens=1000, temperature=0.0)
    ...
    def check(self, question: str, retriever, k=3) -> str:
        ...
        **Important:** 
        a) If the passages mention or reference the topic or timeframe of the question in any way, even if incomplete, respond with "PARTIAL" instead of "NO_MATCH".
        b) Be easy on general questions or requests like 'summarize the case.', or 'what is the case about?' and return CAN_ANSWER.
